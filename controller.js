...
myApp.controller('MyController',['$scope', function($scope) {
    ...
    $scope.myFunc = function(number) {
        $scope.productNumber = number;
        $scope.showMe = true;
    };
    // state finder json data
        $scope.state = [
            {
                "name": "Alabama",
                "abbreviation": "AL"
